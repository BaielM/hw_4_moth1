...
public class Main {
    ...
    public static int[] heroesHealth = {280, 270, 250, 260, 200, 300, 250, 220};
    public static int[] heroesDamage = {10, 15, 20, 0, 15, 10, 15, 20};
    ...
    public static void printStatistics() {
        ...
        System.out.println("Boss health: " + bossHealth + "; damage: " + bossDamage + "; boss defence: " + (bossDefence == null ? "No defence" : bossDefence));
